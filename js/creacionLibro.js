  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Para dejar un comentario es necesario haber iniciado sesión.
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="cerrarboton">Cerrar</button>
        <a href="./login.html"><button type="button" class="btn btn-primary" id="iniciarsesionboton">Iniciar sesión</button></a>
      </div>
    </div>
  </div>
</div>
