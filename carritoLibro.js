...
function addLibro(libro){
    ...
    newImg.src = miLibro.querySelector("div[id='imagen']").querySelector("div").querySelector("div.main_image")
    ...
    newTitulo.innerHTML= miLibro.querySelector('div[id="datos"]').querySelector('div')
        .querySelector('div[id="titulo"]').querySelector('h3').innerHTML
    ...
    newAutor.innerHTML= miLibro.querySelector('div[id="datos"]').querySelector('div')
    .querySelector('div[id="autor"]').querySelector('h5').innerHTML
    ...
    newPrecio.innerHTML= miLibro.querySelector('div[id="datos"]').querySelector('div').querySelectorAll('h3')[1].innerHTML
...
function turnGreen(libro){
    var miLibro = libro
    var boton = miLibro.querySelector('div[id="datos"]').querySelector('div').querySelector('div[id="boton"]').querySelectorAll('button')[1]
